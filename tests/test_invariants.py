...
def test_clean_state_passes(): assert check(BASE,{"rows":[{"date":"2026-01-01"}]},RULES,"2026-01-01")[0] == []
def test_detects_broken_invariants():
    state={**BASE,"totals":{**BASE["totals"],"cash_weight":.48,"total_value":99}}
    messages=check(state,{"rows":[{"date":"2026-01-02"},{"date":"2026-01-01"},{"date":"2026-01-01"}]},RULES,"2026-01-02")[0]
